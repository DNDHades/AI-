...
import com.argent.aiyunzan.common.utils.setStatusBarUtils;
...
public class ActivityLifecycleCallbacksImpl implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityStarted(Activity activity) {
        ...
        //沉浸式
        initStatusBarUtil(activity);
        // 设置默认键盘不弹出
        initSoftInputMode(activity);

    }

    private void initSoftInputMode(Activity activity) {
        activity.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE | WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN);
    }

    private void initStatusBarUtil(Activity activity) {
        setStatusBarUtils setStatusBarUtils = new setStatusBarUtils(activity);
