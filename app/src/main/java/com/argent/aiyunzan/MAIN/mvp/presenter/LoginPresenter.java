...
public class LoginPresenter extends BasePresenter<LoginContract.Model, LoginContract.View> {
    ...
    public void loadLogin(String et_phone, String et_pwd) {
        mModel.loadLogin(et_phone, et_pwd)
                ...
                .subscribe(new ErrorHandleSubscriber<LoginRsp>(mErrorHandler) {
                    @Override
                    public void onNext(LoginRsp data) {
                        ArmsUtils.snackbarText(data.getMsg());
