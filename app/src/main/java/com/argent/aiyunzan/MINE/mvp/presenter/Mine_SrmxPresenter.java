 ...
 */
@ActivityScope
public class Mine_SrmxPresenter extends BasePresenter<Mine_SrmxContract.Model, Mine_SrmxContract.View> {
    @Inject
    ...
    @Inject
    public Mine_SrmxPresenter(Mine_SrmxContract.Model model, Mine_SrmxContract.View rootView) {
    ...
    public void loadData() {
        mModel.loadData()
                ...
                .subscribe(new ErrorHandleSubscriber<MineSrmxRsp>(mErrorHandler) {
                    @Override
                    public void onNext(MineSrmxRsp data) {
