...
import com.argent.aiyunzan.MINE.di.component.DaggerMine_Menu1Click1Component;
import com.argent.aiyunzan.MINE.mvp.contract.Mine_Menu1Click1Contract;
import com.argent.aiyunzan.MINE.mvp.presenter.Mine_Menu1Click1Presenter;
 ...
 * ================================================
 */
public class Mine_Menu1Click1Activity extends BaseActivity<Mine_Menu1Click1Presenter> implements Mine_Menu1Click1Contract.View {
...
//    private Dialog mWeiboDialog;
    ...
    protected void onResume() {
        super.onResume();
        toolbar_title.setText("一级会员");
    }


    @Override
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerMine_Menu1Click1Component //如找不到该类,请编译一下项目
                .builder()
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_mine__menu1_click1; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
