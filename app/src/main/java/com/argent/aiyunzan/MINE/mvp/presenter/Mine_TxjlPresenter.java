 ...
 */
@ActivityScope
public class Mine_TxjlPresenter extends BasePresenter<Mine_TxjlContract.Model, Mine_TxjlContract.View> {
    @Inject
    ...
    @Inject
    public Mine_TxjlPresenter(Mine_TxjlContract.Model model, Mine_TxjlContract.View rootView) {
    ...
    public void loadData(int page) {
        mModel.loadData(page)
                ...
                .subscribe(new ErrorHandleSubscriber<MineTxjlRsp>(mErrorHandler) {
                    @Override
                    public void onNext(MineTxjlRsp data) {
