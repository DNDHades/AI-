 ...
 */
@ActivityScope
public class Mine_Menu1Click1Model extends BaseModel implements Mine_Menu1Click1Contract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public Mine_Menu1Click1Model(IRepositoryManager repositoryManager) {
