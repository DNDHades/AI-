 ...
 */
@ActivityScope
public class Mine_Menu1Click1Presenter extends BasePresenter<Mine_Menu1Click1Contract.Model, Mine_Menu1Click1Contract.View> {
    @Inject
    ...
    @Inject
    public Mine_Menu1Click1Presenter(Mine_Menu1Click1Contract.Model model, Mine_Menu1Click1Contract.View rootView) {
    ...
    public void loadData(int page) {
        mModel.loadData(page)
                ...
                .subscribe(new ErrorHandleSubscriber<MineTdxqRsp>(mErrorHandler) {
                    @Override
                    public void onNext(MineTdxqRsp data) {
