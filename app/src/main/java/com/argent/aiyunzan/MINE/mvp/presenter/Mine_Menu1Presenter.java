 ...
 */
@ActivityScope
public class Mine_Menu1Presenter extends BasePresenter<Mine_Menu1Contract.Model, Mine_Menu1Contract.View> {
    @Inject
    ...
    @Inject
    public Mine_Menu1Presenter(Mine_Menu1Contract.Model model, Mine_Menu1Contract.View rootView) {
    ...
    public void loadData() {
        mModel.loadData()
                ...
                .subscribe(new ErrorHandleSubscriber<MineWdtdRsp>(mErrorHandler) {
                    @Override
                    public void onNext(MineWdtdRsp data) {
