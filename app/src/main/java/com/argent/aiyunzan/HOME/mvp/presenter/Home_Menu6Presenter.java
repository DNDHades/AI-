 ...
 */
@ActivityScope
public class Home_Menu6Presenter extends BasePresenter<Home_Menu6Contract.Model, Home_Menu6Contract.View> {
    @Inject
    ...
    @Inject
    public Home_Menu6Presenter(Home_Menu6Contract.Model model, Home_Menu6Contract.View rootView) {
    ...
    public void loadData() {
        mModel.loadData()
                ...
                .subscribe(new ErrorHandleSubscriber<HomeMenu6XszyRsp>(mErrorHandler) {
                    @Override
                    public void onNext(HomeMenu6XszyRsp data) {
