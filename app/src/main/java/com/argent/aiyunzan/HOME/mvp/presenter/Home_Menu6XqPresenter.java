 ...
 */
@ActivityScope
public class Home_Menu6XqPresenter extends BasePresenter<Home_Menu6XqContract.Model, Home_Menu6XqContract.View> {
    @Inject
    ...
    @Inject
    public Home_Menu6XqPresenter(Home_Menu6XqContract.Model model, Home_Menu6XqContract.View rootView) {
...
//                    mRootView.hideLoading();//隐藏下拉刷新的进度条
                ...
                .subscribe(new ErrorHandleSubscriber<HomeMenu6XszyXqRsp>(mErrorHandler) {
                    @Override
                    public void onNext(HomeMenu6XszyXqRsp data) {
                        if (data.getCode() == Api.SUCCESS) {
                            mRootView.loadHomeSuccess(data.getData());
                        }
                    }
                });
    }
