 ...
 */
@ActivityScope
public class Home_Menu3Presenter extends BasePresenter<Home_Menu3Contract.Model, Home_Menu3Contract.View> {
    @Inject
    ...
    @Inject
    public Home_Menu3Presenter(Home_Menu3Contract.Model model, Home_Menu3Contract.View rootView) {
    ...
    public void loadData() {
        mModel.loadData()
                ...
                .subscribe(new ErrorHandleSubscriber<Home_Menu3Rsp>(mErrorHandler) {
                    @Override
                    public void onNext(Home_Menu3Rsp data) {
