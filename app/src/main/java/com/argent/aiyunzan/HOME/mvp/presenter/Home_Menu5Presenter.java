 ...
 */
@ActivityScope
public class Home_Menu5Presenter extends BasePresenter<Home_Menu5Contract.Model, Home_Menu5Contract.View> {
    @Inject
    ...
    @Inject
    public Home_Menu5Presenter(Home_Menu5Contract.Model model, Home_Menu5Contract.View rootView) {
